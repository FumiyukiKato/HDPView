...
table::table(const string& dataset_dir, bool is_train, bool func1) : func(func1) {
	// read domai
	ifstream fdomain(dataset_dir + "domain_info.txt");
   ...
   std::cout << file_name << std::endl;
	...
	ifstream fdata(dataset_dir + file_name);
